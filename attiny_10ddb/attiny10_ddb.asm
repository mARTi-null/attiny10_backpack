/***********************************************************************************************************************
Double Dabble algorithm for Attiny10 written in assembly
...
The whole function is written in avr assembler and takes only 46 bytes of program memory when compiled
...
Example of extracting individual digits from R18:
	...
	swap	Rn					; Swap Rn high and low nibble places to have all individual digits
								  in lower nibble or R19, Rn and R18
------------------------------------------------------------------------------------------------------------------------
